...
public class D3Test {
    ...
    public void tEST1LINKS() {
        ...
        assertEquals(vars.get("link").toString(), "localhost:8080/reset");
    }
    ...
    // assertThat(driver.findElement(By.xpath("//div[4]")).getText(), is(not("Cat
    // fight!")));
    // }
    ...
    // driver.findElement(By.cssSelector(".btn")).click();
    // assertThat(driver.findElement(By.xpath("//div[4]")).getText(), is(not("Nom,
    // nom, nom.")));
    // }
    ...
    // assertThat(driver.findElement(By.xpath("//div[2]/h4")).getText(),
    // is("Meow!Meow!"));
    // }
    ...
    public void tEST3CATALOG() {
        ...
        assertEquals(vars.get("src").toString(), "localhost:8080/images/cat2.jpg");
    }
    ...
    public void tEST11GREETACATWITHNAME() {
        driver.get("localhost:8080/greet-a-cat/Jennyanydots");
        js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
